...
def createLocations(itemArray):
	...
	locations.append(WorldLocation(1, "The Varen Tree", "The Tree of Life, or so they say. A giant tree rises from the ground, a warm brown trunk with infinite branches and green leaves that shine golden in the sun.", "World", [], [itemArray[0], itemArray[1], itemArray[2], itemArray[3]]))
