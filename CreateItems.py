...
def createItems():
	...
	items.append(Potion(1, "Healing Potion", "A bottle which contains a potion that, when drunk, heals the user.", "Healing", 10))
	...
	items.append(Armor(2, "Silver-White Light Armor", "A fine set of armor worn long ago and crafted, some say, by the hammer of Welf Crozzo.", 30))
